  ...
  if (result.isConfirmed) {
    ...
    return (
      ...
      <td className="text-center">
        ...
        <Button variant="danger" onClick={eliminarProducto} className='me-lg-2'>
          <i className="bi bi-trash"></i>
        </Button>
        <Button variant="transparent" onClick={() => destacarProducto(producto.id)}>
          {producto.destacada? <i className="bi bi-star-fill fs-4 text-success"></i> : <i className="bi bi-star text-success"></i>}
        </Button>
        </div>
      </td>
    </tr>
